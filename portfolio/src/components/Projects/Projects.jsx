...
const mediaProjects = [
    {
        ...
        images: [
            { src: '/assets/img/project-dealgames-1.png', alt: 'Page d’accueil de Dealgames' },
            { src: '/assets/img/project-dealgames-2.png', alt: 'Fiche d’un jeu sur Dealgames' },
            { src: '/assets/img/project-dealgames-3.png', alt: 'Espace de négociation sur Dealgames' },
        ],
    ...
    },
    {
        ...
        images: [
            { src: '/assets/img/project-colimbrick-1.png', alt: 'Page d’accueil de Colimbrick' },
            { src: '/assets/img/project-colimbrick-2.png', alt: 'Création d’un devis sur Colimbrick' },
            { src: '/assets/img/project-colimbrick-3.png', alt: 'Formulaire rempli sur Colimbrick' },
        ],
